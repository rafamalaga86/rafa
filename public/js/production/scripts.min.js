...
function arrowShake() {
    var a = document.querySelector("a.arrow");
    moved || (a.className = a.className + " shake", setTimeout(function() {
        a.className = "arrow"
    }, 1e3))
}
...
FastClick.prototype.needsClick = function(a) {
    ...
    function(a) {
        ...
        c.prototype.options = {
            ...
            var a = this,
                b = this.questions[this.current].querySelector("input"),
                c = function() {
                    b.removeEventListener("focus", c), classie.addClass(a.ctrlNext, "show")
                };
            b.addEventListener("focus", c), this.ctrlNext.addEventListener("click", function(b) {
                b.preventDefault(), a._nextQuestion()
            }), document.addEventListener("keydown", function(b) {
                var c = b.keyCode || b.which;
                13 === c && (b.preventDefault(), a._nextQuestion())
            }), this.el.addEventListener("keydown", function(a) {
                var b = a.keyCode || a.which;
                9 === b && a.preventDefault()
            })
        }, c.prototype._nextQuestion = function() {
            if (!this._validade()) return !1;
            this.current === this.questionsCount - 1 && (this.isFilled = !0), this._clearError();
            var a = this.questions[this.current];
            if (++this.current, this._progress(), !this.isFilled) {
                this._updateQuestionNumber(), classie.addClass(this.el, "show-next");
                var b = this.questions[this.current];
                classie.removeClass(a, "current"), classie.addClass(b, "current")
            }
            var c = this,
                d = function() {
                    f.transitions && this.removeEventListener(e, d), c.isFilled ? (c._submit(), $("#loader-container").show()) : (classie.removeClass(c.el, "show-next"), c.currentNum.innerHTML = c.nextQuestionNum.innerHTML, c.questionStatus.removeChild(c.nextQuestionNum), b.querySelector("input").focus())
                };
            f.transitions ? this.progress.addEventListener(e, d) : d()
        }, c.prototype._progress = function() {
            this.progress.style.width = this.current * (100 / this.questionsCount) + "%"
        }, c.prototype._updateQuestionNumber = function() {
            ...
            var a = this.questions[this.current].querySelector("input").value,
                b = this.questions[this.current].querySelector("input").getAttribute("type"),
                c = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
            return "email" !== b || c.test(a) ? "" === a ? (this._showError("EMPTYSTR"), !1) : !0 : (this._showError("INVALIDEMAIL"), !1)
            ...
            switch (a) {
                case "EMPTYSTR":
                    ...
                    break;
                case "INVALIDEMAIL":
                    b = $("form").data("invalidemail")
            }
            this.error.innerHTML = b, classie.addClass(this.error, "show")
        }, c.prototype._clearError = function() {
            classie.removeClass(this.error, "show")
        }, a.stepsForm = c
    }(window);
var MorphingDevice = function(a, b) {
    function c() {
        s.style.display = "none", s.onclick = function() {
            h(), p.className = r ? p.className.replace(/\b md-rotated\b/, "") : p.className + " md-rotated";
            var a = r ? b.devices[q].imgsrc : b.devices[q].rotatedsrc;
            return e(a), r = !r, !1
        }, p.appendChild(s);
        var a = getHiddenProp();
        if (a) {
    ...
    function d() {
        p.className = "md-device " + b.devices[q].cName, r = !1, s.style.display = b.devices[q].canRotate ? "" : "none", e(b.devices[q].imgsrc)
    }

    function e(a) {
        var b = t.parentNode,
            c = document.createElement("img");
        c.setAttribute("src", a), b.childNodes.length > 1 && b.removeChild(b.firstChild), b.insertBefore(c, t), t.className = "md-fadeout", t.addEventListener(n, function() {
            t = c, null != this.parentNode && this.parentNode.removeChild(this)
        }, !1)
    }
    ...
    function g() {
        l = setTimeout(function() {
            var a = q < devicesTotal - 1 ? q + 1 : 0;
            k(nav.children[a]), q = a, d(), b.autoplay && g()
        }, b.interval)
    }
    ...
    function k(a) {
        var b = nav.children;
        b[q].className = b[q].className.replace(/\bmd-current\b/, ""), a.className = "md-current"
    }
    var l, m = {
            WebkitTransition: "webkitTransitionEnd",
            MozTransition: "transitionend",
        ...
        n = m[Modernizr.prefixed("transition")],
        o = !1,
        p = a.querySelector("div.md-device"),
        q = 0,
        r = !1,
        s = document.createElement("button"),
        t = p.querySelector(".md-inner > img");
    return c(), {
        init: c,
        setCurrent: i,
        getCurrent: j,
...
$(window).on("scroll", function() {
    moved = !0
}), setInterval(arrowShake, 5e3), jQuery(function(a) {
    function b() {
        var b = a(window).height();
        a(".full-screen-section").height(b), a("body").css("padding-bottom", b)
    }

    function c() {
        a(window).width() <= 1024 ? a("header").removeClass("full-screen-section") : a("header").addClass("full-screen-section")
    }

    function d() {
        e++, e >= f.length && (e = 0)
    }
    a(document).foundation(), c(), b(), a(window).on("resize", function() {
        b(), c()
    });
    var e, f = a(".what-i-love").data("what").split(","),
        g = Math.random() * f.length;
    e = Math.round(g), (e >= f.length || 0 > e) && (e = f.length - 1);
    var h = document.getElementsByClassName("like");
    h[0].innerHTML = f[e], setInterval(function() {
        a(".like").fadeOut("fast", function() {
            d();
            var b = f[e];
            a(".like").html(b), a(".like").fadeIn("fast")
        })
    }, 4e3), a(window).on("scroll", function() {
        a(window).scrollTop() >= 500 && !a(".s-navigation").hasClass("opaque") ? a(".s-navigation").addClass("opaque") : a(window).scrollTop() < 500 && a(".s-navigation").hasClass("opaque") && a(".s-navigation").removeClass("opaque")
    }), a(document).on("open.fndtn.reveal", "[data-reveal]", function() {
        a(this).find(".close-reveal-modal").addClass("clickable")
    }), a(document).on("close.fndtn.reveal", "[data-reveal]", function() {
        a(this).find(".close-reveal-modal.clickable").removeClass("clickable")
    }), a(window).on("scroll", function() {
        a(".close-reveal-modal.clickable").length > 0 && a(".close-reveal-modal.clickable").trigger("click")
    });
    var i = document.getElementById("theForm");
    new stepsForm(i, {
        onSubmit: function() {
            classie.addClass(i.querySelector(".simform-inner"), "hide"), post_data = {
                userName: a("input[name=name]").val(),
                userEmail: a("input[name=email]").val(),
                userSubject: "Email from rafaelgarciadoblas.com page:",
                userMessage: a("input[name=mess]").val(),
                userLanguage: a("input[name=language]").val()
            }, a.post("/contact_me.php", post_data, function(b) {
                var c = i.querySelector(".final-message");
                c.innerHTML = "error" == b.type ? '<span class="error">' + b.text + "</span>" : '<span class="success">' + b.text + "</span>", a("#loader-container").fadeOut(), classie.addClass(c, "show")
            }, "json")
        }
    });
    var j = {
        ...
        k = document.getElementById("loader-container"),
        l = (new Spinner(j).spin(k), document.querySelector(".mym")),
        m = "softwaredevelopmentspain";
    rhs = "gmail.com",
    l.innerHTML = '<A HREF="mailto:' + m + "@" + rhs + '">' + m + "@" + rhs + "</A>"
});